          ...
          {industries.map((industry) => {
            ...
            return (
              <motion.li
                key={industry.id}
                variants={item}
                className="group relative flex flex-col rounded-2xl border border-ink-900/[0.08] bg-white p-7 shadow-card transition-all duration-300 hover:-translate-y-1 hover:border-ink-900/[0.14] hover:shadow-card-hover"
              >
